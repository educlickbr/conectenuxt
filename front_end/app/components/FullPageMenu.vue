...
<template>
  ...
  >
    <!-- 1. Sleek Header -->
    <header class="bg-div-15 border border-[#6B82A733] rounded px-4 py-3 flex items-center justify-between shadow-sm shrink-0">
      <div class="flex items-center gap-3">
        <div class="w-9 h-9 rounded-full bg-[#3571CB1A] text-primary flex items-center justify-center font-bold text-lg">
      ...
      <div class="flex items-center gap-2">
        ...
        <button
          v-if="!isInicio"
          @click="closeMenu"
          class="p-2 text-secondary hover:text-danger hover:bg-[#C33C540D] rounded transition-all"
        >
    ...
    <main class="flex-1 overflow-y-auto px-2 space-y-8 max-w-6xl mx-auto w-full">
      ...
      <section class="flex justify-end pt-2">
         <button
          @click="handleLogout"
          class="flex items-center gap-2 px-4 py-2 bg-[#C33C541A] text-danger rounded hover:bg-[#C33C5433] transition-all font-bold text-xs"
        >
          ...
          <div class="bg-div-15 border border-[#6B82A71A] rounded overflow-hidden shadow-sm">
            ...
            <button @click="handleNavigation('/admin/avaliacao')" class="menu-item group border-t border-[#6B82A70D]">
              ...
              <div class="flex flex-col text-left">
                ...
                <span class="text-[10px] text-secondary">Critérios e Modelos</span>
              </div>
            </button>
          </div>
        </div>
