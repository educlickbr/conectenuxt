...
<template>
    <Teleport to="body">
        <div v-if="isOpen" class="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-6">
            ...
            <!-- Modal Content -->
            <div class="relative bg-background w-full max-w-4xl max-h-[90vh] flex flex-col rounded shadow-2xl border border-secondary/10 overflow-hidden transform transition-all">
                ...
                <div class="flex-1 overflow-y-auto p-6">
                    ...
                    <!-- Empty State -->
                    <div v-if="!isLoadingSchema && filteredSchema.length === 0" class="text-center py-20 text-secondary/50">
