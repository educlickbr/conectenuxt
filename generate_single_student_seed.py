...
output_path = '/home/eikmeier/Documentos/dev/nuxt/conectenuxt/documentacao/db/ad-hoc/seed_student_test.sql'
...
try:
    with open(csv_path, 'r', encoding='utf-8') as f_in, open(output_path, 'w', encoding='utf-8') as f_out:
        ...
        f_out.write("-- Migration generated automatically (SINGLE STUDENT TEST)\n")
        f_out.write("-- Seeding user_expandido and respostas_user for 1 student\n\n")
...
"""
    ...
    print(f"Test seed generated: {output_path} with {count} student.")
