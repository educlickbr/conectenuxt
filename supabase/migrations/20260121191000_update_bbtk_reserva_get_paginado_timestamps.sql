-- Update bbtk_reserva_get_paginado to return new columns and fix JOIN
-- Ensures timestamps are returned and user join is correct (ue.id vs ue.user_id)
...
BEGIN
    ...
    LEFT JOIN user_expandido ue ON hi.user_uuid = ue.id  -- CORRECTED JOIN: user_uuid -> ue.id
