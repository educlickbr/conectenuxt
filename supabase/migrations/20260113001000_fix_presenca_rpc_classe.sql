-- Migration: Fix diario_presenca_get_por_turma to use classe.nome
-- Date: 2026-01-13
-- Description: Updates the function to correctly join with public.classe to get the class name.
