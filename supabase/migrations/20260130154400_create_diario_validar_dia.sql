-- Create RPC to validate if a day is valid for attendance registration
-- Returns validation status, reason, details, and available components
...
-- Grant permissions
GRANT EXECUTE ON FUNCTION diario_validar_dia(UUID, UUID, DATE) TO authenticated;
