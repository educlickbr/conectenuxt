-- Refinamento do diario_presenca_get_por_turma para buscar somente alunos ATIVOS
-- User reportou que get anterior não retornava alunos corretamente. 
-- Schema indica que status='ativa' é o padrão e indexado.
...
BEGIN
    ...
    FROM (
        ...
        WHERE 
            ...
            -- Filtros estritos de status 'ativa' conforme indicação do user e schema
            AND mt.status = 'ativa'
            AND m.status = 'ativa'
