-- Refinamento de Turmas: Filtros de Ano e Período
-- Data: 2026-01-10 18:45

-- 1. DROP da função anterior (assinatura antiga)
DROP FUNCTION IF EXISTS public.turmas_get_paginado(uuid, integer, integer, text);

-- 2. CREATE da função com novos parâmetros
