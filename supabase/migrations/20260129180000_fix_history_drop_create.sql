-- Migration: Fix cleanup and recreation of matricula_turma_get_historico
-- Reason: Ensure we are not hitting a stale function overload. Explicitly DROP first.
-- Also includes all previous fixes: LEFT JOINs and Enum Casting.
...
BEGIN
    ...
    RETURN jsonb_build_object(
        ...
        'debug_info', jsonb_build_object(
            ...
            'rows_found', v_count,
            'version', 'v3-drop-create-left-join'
        )
    );
END;
$function$;
