-- Migration to update bbtk_obra_upsert_cpx to accept id_arquivo_capa and id_arquivo_livro
    ...
    LOOP
        ...
        IF (v_edicao_item->>'uuid') IS NULL OR (v_edicao_item->>'uuid') = '' THEN
            INSERT INTO public.bbtk_edicao (
                ...
                p_id_empresa,
                NULLIF(v_edicao_item->>'id_arquivo_capa', '')::uuid,
                NULLIF(v_edicao_item->>'id_arquivo_livro', '')::uuid
            );
        ELSE
            UPDATE public.bbtk_edicao SET
                ...
                id_arquivo_capa = NULLIF(v_edicao_item->>'id_arquivo_capa', '')::uuid,
                id_arquivo_livro = NULLIF(v_edicao_item->>'id_arquivo_livro', '')::uuid
