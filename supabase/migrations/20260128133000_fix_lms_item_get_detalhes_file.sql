-- Update lms_item_get_detalhes to include book file path (arquivo_pdf aliased as arquivo)
    ...
    SELECT json_build_object(
        ...
        'livro_digital', CASE WHEN i.id_bbtk_edicao IS NOT NULL THEN
             (SELECT json_build_object(
                ...
                'capa', e.arquivo_capa,
                'arquivo', e.arquivo_pdf  -- Correct column name found in bbtk_edicao_get_paginado
              ) 
