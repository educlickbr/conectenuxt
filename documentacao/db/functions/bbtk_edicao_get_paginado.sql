DROP FUNCTION public.bbtk_edicao_get_paginado;
CREATE OR REPLACE FUNCTION public.bbtk_edicao_get_paginado(
    p_id_empresa uuid,
    p_pagina integer DEFAULT 1,
    p_limite_itens_pagina integer DEFAULT 10,
    p_termo_busca text DEFAULT NULL::text,
    p_tipo_livro text DEFAULT 'Impresso'::text,
...
ALTER FUNCTION public.bbtk_edicao_get_paginado(uuid, integer, integer, text, text, uuid)
    OWNER TO postgres;
