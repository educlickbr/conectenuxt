DROP FUNCTION IF EXISTS public.bbtk_dim_metadado_get_paginado(uuid, integer, integer, text);

CREATE OR REPLACE FUNCTION public.bbtk_dim_metadado_get_paginado(
    p_id_empresa uuid,
