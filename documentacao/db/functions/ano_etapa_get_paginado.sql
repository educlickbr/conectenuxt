CREATE OR REPLACE FUNCTION public.ano_etapa_get_paginado(
	p_id_empresa uuid,
...
ALTER FUNCTION public.ano_etapa_get_paginado(p_id_empresa uuid, p_pagina integer, p_limite_itens_pagina integer, p_busca text)
    OWNER TO postgres;
