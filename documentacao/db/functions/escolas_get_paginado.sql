CREATE OR REPLACE FUNCTION public.escolas_get_paginado(
	p_id_empresa uuid,
...
ALTER FUNCTION public.escolas_get_paginado(p_id_empresa uuid, p_pagina integer DEFAULT 1, p_limite_itens_pagina integer DEFAULT 10, p_busca text DEFAULT ''::text)
    OWNER TO postgres;
