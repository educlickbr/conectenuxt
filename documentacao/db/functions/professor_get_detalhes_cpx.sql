DROP FUNCTION public.professor_get_detalhes_cpx;
CREATE OR REPLACE FUNCTION public.professor_get_detalhes_cpx(
    p_id_empresa uuid,
    p_id_professor uuid -- user_expandido.id
)
RETURNS json
LANGUAGE plpgsql
COST 100
...
ALTER FUNCTION public.professor_get_detalhes_cpx(uuid, uuid)
    OWNER TO postgres;
